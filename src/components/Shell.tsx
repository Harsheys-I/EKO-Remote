import { Activity, Bluetooth, BrainCircuit, Camera, CircleStop, Database, Gamepad2, Gauge, Link2, Radio, RefreshCw, Settings2, Unplug, Wifi } from "lucide-react";
import type { LinkStats, RobotState } from "../types";

export type ViewId = "dashboard" | "drive" | "ai" | "vision" | "memory" | "logs" | "settings";
const navigation = [
...
const titles: Record<ViewId, [string, string]> = { dashboard: ["SYSTEM OVERVIEW", "Dashboard"], drive: ["MOTION SYSTEM", "Drive EKO"], ai: ["INTELLIGENCE", "AI & voice"], vision: ["PERCEPTION", "Vision"], memory: ["PERSISTENCE", "Memory bank"], logs: ["OBSERVABILITY", "Runtime logs"], settings: ["CONFIGURATION", "Remote settings"] };
