...
class APIClientTests(unittest.TestCase):
    ...
    def test_v140_navigation_routes(self) -> None:
        self.assertEqual(EkoAPI._route("navigation.status", {}), ("GET", "/navigation/status", None))
        self.assertEqual(
            EkoAPI._route("navigation.plan", {"destination": "Kitchen"}),
            ("POST", "/navigation/plan", {"destination": "Kitchen"}),
        )
        self.assertEqual(
            EkoAPI._route(
                "navigation.go",
                {"destination": {"x_m": 2.0, "y_m": 3.0}, "return_to_start": True},
            ),
            (
                "POST",
                "/navigation/go",
        ...
        self.assertEqual(EkoAPI._route("navigation.stop", {}), ("POST", "/navigation/stop", {}))
        self.assertEqual(
            EkoAPI._route("navigation.relocalize", {}),
            ("POST", "/navigation/relocalize", {}),
        )
        self.assertEqual(
            EkoAPI._route("navigation.obstacles.clear", {}),
            ("POST", "/navigation/obstacles/clear", {}),
        )
