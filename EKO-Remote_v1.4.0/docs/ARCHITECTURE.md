# EKO Remote v1.4.0 architecture
...
| `src/pages/MapPage.tsx` | Floor editor, odometry, routes, obstacle beliefs, and navigation controls |
| `src/pages/LogsPage.tsx` | Grouped low-noise structured event inspector |
| `src/pages/TerminalPage.tsx` | Stable authenticated xterm PTY surface |
...
There is no Mock Mode in v1.4.0:
...
- House Map renders Pi-fused optical-mouse translation, Nano MPU yaw, planned routes, and remembered obstacles; route controls still ask the Pi to make every decision.
